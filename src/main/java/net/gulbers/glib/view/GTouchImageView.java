...
public class GTouchImageView extends android.support.v7.widget.AppCompatImageView {
    ...
    // when the image is stretched to fit com.toko9000.android.view.
    //
    ...
    //
    // Size of com.toko9000.android.view and previous com.toko9000.android.view size (ie before
    // rotation)
    //
    private int viewWidth, viewHeight, prevViewWidth, prevViewHeight;
    //
    // Size of image when it is stretched to fit com.toko9000.android.view. Before and After
    // rotation.
    //
    ...
    public GTouchImageView(Context context, AttributeSet attrs) {
        super(context, attrs);
        sharedConstructing(context);
    }

    public GTouchImageView(Context context, AttributeSet attrs, int defStyle) {
    ...
    /**
     * Save the current matrix and com.toko9000.android.view dimensions in the prevMatrix and
     * prevView variables.
     */
     ...
     * point as a fraction from the left and top of the com.toko9000.android.view. For example, the
    ...
    public void setZoom(float scale, float focusX, float focusY, ScaleType scaleType) {
        ...
        // point,
        // image and com.toko9000.android.view sizes have not yet been calculated in onMeasure.
        // Thus,
        // we should
        // delay calling setZoom until the com.toko9000.android.view has been measured.
        //
        if (!onDrawReady) {
     ...
     */
    public void setZoom(GTouchImageView img) {
     ...
     * as a fraction from the left and top of the com.toko9000.android.view. For example, the top
     ...
     * a fraction from the left and top of the com.toko9000.android.view. The focus points can
     * range
     ...
     * versa) the image can become unaligned within the com.toko9000.android.view. This is apparent
     * when zooming quickly. When the content size is less than the com.toko9000.android.view size,
     * the content will often be centered incorrectly within the com.toko9000.android.view.
     * fixScaleTrans first calls fixTrans() and then makes sure the image is
     * centered correctly within the com.toko9000.android.view.
     */
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        //
        // Set com.toko9000.android.view dimensions
        //
        setMeasuredDimension(viewWidth, viewHeight);

        //
        // Fit content within com.toko9000.android.view
        //
        fitImageToView();
    }
    ...
    private void fitImageToView() {
        ...
        //
        // Scale image for com.toko9000.android.view
        //
        ...
        if (!isZoomed() && !imageRenderedAtLeastOnce) {
            //
            // Stretch and center image to fit com.toko9000.android.view
            //
    ...
    /**
     * Set com.toko9000.android.view dimensions based on layout params
     *
     * @param mode
     * @param size
     * @param drawableWidth
     ...
     * @param prevViewSize  width/height of com.toko9000.android.view before rotation
     * @param viewSize      width/height of com.toko9000.android.view after rotation
    ...
    private void translateMatrixAfterRotate(int axis, float trans, float prevImageSize, float
        ...
        if (imageSize < viewSize) {
            //
            // The width/height of image is less than the com.toko9000.android.view's width/height.
            // Center it.
            //
            ...
            //
            // The image is larger than the com.toko9000.android.view, but was not before rotation.
            // Center it.
            //
            ...
            // com.toko9000.android.view. Determine its distance
            // from the left/top side of the com.toko9000.android.view as a fraction of the entire
            // image's width/height. Use that percentage
            // to calculate the trans in the new com.toko9000.android.view width/height.
            //
     ...
     * @param clipToBitmap Touch event may occur within com.toko9000.android.view, but outside
     *                     image content.
     ...
     * coordinates in the drawable's coordinate system to the com.toko9000.android.view's
     * coordinate
     * system.
     *
     * @param bx x-coordinate in original bitmap coordinate system
     * @param by y-coordinate in original bitmap coordinate system
     * @return Coordinates of the point in the com.toko9000.android.view's coordinate system.
     */
     ...
     * to the com.toko9000.android.view's listener.
     *
     * @author Ortiz
     */
